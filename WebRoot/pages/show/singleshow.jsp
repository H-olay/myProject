                    ...
                    <table border="0" width="100%" cellspacing="0" cellpadding="2">
                        ...
                        <s:else>
                            ...
                            <tr height="40">
                                ...
                                <td><s:property value="infoSingle.infoTitle"/></td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <table border="1" width="630" cellspacing="0" cellpadding="10" rules="none" frame="below" style="word-break:break-all" bordercolor="lightgrey" bordercolorlight="lightgrey" bordercolordark="white">
                                        <tr height="200" bgcolor="white"><td colspan="3" valign="top" style="border:1 solid"><s:property value="infoSingle.infoContent" escape="false"/></td></tr>
